...
namespace eval ttk::theme::dark {
    ...
    ttk::style theme create dark -parent clam -settings {
        ...
        ttk::style layout SwitchTheme.TCheckbutton {
            SwitchTheme.button -children {
                SwitchTheme.padding -children {
                    SwitchTheme.indicator -side left
                    SwitchTheme.label -side right -expand true
                } 
            }
        }
        ...
        # SwitchTheme
        ttk::style element create SwitchTheme.indicator image \
            [list $I(off-basic) \
