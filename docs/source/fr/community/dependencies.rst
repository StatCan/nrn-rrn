...
dépendance spécifiques sont décrits dans le fichier d'environnement conda ``environment.yml``. Ce document explique
brièvement chacune des dépendances au sein de l'écosystème de dépendances RRN.
