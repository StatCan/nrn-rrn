...
| **David Craig** | Intégration et traitement des données | david.craig@statcan.gc.ca
...
.. |logo_statscan| image:: /source/_static/affiliations/statistics_canada_fr.png
   :alt: Logo de Statistique Canada.
   :target: https://www.statcan.gc.ca/
   :height: 25px
   :align: middle

.. |logo_geobase| image:: /source/_static/affiliations/geobase_fr.png
   :alt: Logo de GéoBase.
   :target: http://geobase.ca/
   :height: 35px
   :align: middle

.. |logo_ccog| image:: /source/_static/affiliations/ccog.png
   :alt: Logo de COCG.
...
des fichiers de configuration source individuels (voir :doc:`/source/fr/user_guide/conform`). La carte de couverture
