...
Le schéma RRN est défini dans :doc:`feature_catalogue`.
...
.. csv-table::
   ...
   "**kwargs", "Mots-clés passés à :func:`re.sub`. Cette fonction étend l'argument ``repl`` de telle sorte qu'il puisse
   être une expression régulière compilable ou un dictionnaire de mappages de valeurs."
